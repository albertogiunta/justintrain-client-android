...
public class CONST_ANALYTICS {
    ...
    // SOLUTION DETAILS
    public static final String ACTION_SET_FAVOURITE                  = "Set favourite from solution";
    public static final String ACTION_SET_FAVOURITE_WITH_JOURNEY     = "Set favourite from solution (solution and journey)";
    public static final String ACTION_REMOVE_FAVOURITE               = "Remove favourite from solution";
    ...
    public static final String ACTION_SHOW_NEWS_DIALOG               = "Show news dialog";
