...
public class SettingsPreferences {
    ...
    private static void setNewSettingsNotPreviouslyIncludedBefore46(Context context) {
        // 43 - 1.0.0
    ...
    public static void setDefaultSharedPreferencesOnFirstStart(Context context) {
        ...
        setNewSettingsNotPreviouslyIncludedBefore46(context);
    }
    ...
    public static void setNewSettingsNotPreviouslyIncludedBefore(Context context) {
        ...
        if (getPreviouslySavedVersionCode(context) < 46) {
            setNewSettingsNotPreviouslyIncludedBefore46(context);
        }
    }
